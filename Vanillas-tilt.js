...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./Vanillas-tilt_files/css" rel="stylesheet">
    <link href="./Vanillas-tilt_files/style.css" rel="stylesheet">
    <link href="./Vanillas-tilt_files/prism.css" rel="stylesheet">
    <script type="text/javascript" src="./Vanillas-tilt_files/prism.js.download"></script>
</head>
<body>

<aside>
    <a href="https://github.com/micku7zu/vanilla-tilt.js" class="logo" id="logo" data-tilt="" data-tilt-glare="true" data-tilt-max-glare="0.5" data-tilt-speed="400" data-tilt-scale="1.1" data-tilt-max="10" data-tilt-perspective="500" style="transform: perspective(500px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
        <span>vanilla-tilt.js</span>
    <div class="js-tilt-glare" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none;"><div class="js-tilt-glare-inner" style="position: absolute; top: 50%; left: 50%; pointer-events: none; background-image: linear-gradient(0deg, rgba(255, 255, 255, 0) 0%, rgb(255, 255, 255) 100%); width: 330px; height: 330px; transform: rotate(180deg) translate(-50%, -50%); transform-origin: 0% 0%; opacity: 0;"></div></div></a>
    <h3>Credits </h3>
    <h6>Original idea and author:</h6>
    <a href="http://gijsroge.github.io/tilt.js/" class="logo" id="logoJquery" data-tilt="" data-tilt-glare="true" data-tilt-max-glare="0.8" data-tilt-speed="400" data-tilt-scale="1.1" data-tilt-max="10" data-tilt-perspective="500" style="transform: perspective(500px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
        <span>tilt.js</span>
    <div class="js-tilt-glare" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none;"><div class="js-tilt-glare-inner" style="position: absolute; top: 50%; left: 50%; pointer-events: none; background-image: linear-gradient(0deg, rgba(255, 255, 255, 0) 0%, rgb(255, 255, 255) 100%); width: 300px; height: 300px; transform: rotate(180deg) translate(-50%, -50%); transform-origin: 0% 0%; opacity: 0;"></div></div></a>
    <br>
    <h3>Contributors</h3>
    <ul>
        <li>
    ...
    <a href="https://play.google.com/store/apps/details?id=com.quickcursor" title="Quick Cursor Android app" target="_blank" id="quickcursor" data-tilt="" data-tilt-glare="true" data-tilt-max-glare="0.8" data-tilt-speed="400" data-tilt-scale="1.1" data-tilt-max="10" data-tilt-perspective="500" style="transform: perspective(500px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
...
<main>
    <section>
        ...
        <br>
        <iframe src="./Vanillas-tilt_files/tweet_button.html" width="75" height="28" scrolling="no" title="Twitter Tweet Button" style="border: 0; overflow: hidden;">
        </iframe>
        <iframe src="./Vanillas-tilt_files/github-btn.html" frameborder="0" scrolling="0" width="160px" height="30px"></iframe>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">&gt;</span></span></code></pre>
    ...
    <section class="example">
        <div class="box" data-tilt="" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-reverse="true" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
            <h3>Reverse tilt</h3>
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-reset="false" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
            <h3>Keep floating</h3>
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-full-page-listening="" style="transform: perspective(1000px) rotateX(-0.83deg) rotateY(3.59deg) scale3d(1, 1, 1);"></div>
        <div class="info">
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-scale="1.1" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-startx="-25" data-tilt-starty="-25" data-tilt-max="25" style="transform: perspective(1000px) rotateX(-25deg) rotateY(25deg) scale3d(1, 1, 1); will-change: transform;"></div>
        <div class="info">
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-axis="y" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
    ...
    <section class="example">
        <div class="box" data-tilt="" data-tilt-axis="x" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
    ...
    <section class="example">
        <div class="box" id="destroy-box" style="transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"></div>
        <div class="info">
...
<script type="text/javascript" src="./Vanillas-tilt_files/vanilla-tilt.min.js.download"></script>
<script>
